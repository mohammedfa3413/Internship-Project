...
const SubscriptionForm = () => {
  ...
  const FORM_URL = `https://app.convertkit.com/forms/3634525/subscriptions`
    ...
    >
      ...
      <div className={classes.gridForm}>
        ...
        <Button
          ...
          size="large"
        >
          <SendIcon color="blue" style={{ verticalAlign: 'middle' }} />
        </Button>
      </div>
    </form>
  )
  ...
  return (
    <Card elevation={1} className={classes.newsletter}>
      ...
      <Grid align="center">
        <EmailIcon style={{ fontSize: '60px' }} color="white" />
        <Typography variant="subtitle1" color="white">
          Keep Updated. Subscribe to Our Mail alerts.
        </Typography>
      </Grid>
